...
| 単発タップ | Z | X | C | V | B |  |  |  | N | M | , | . | / |
| ホールド | LShift | 〃 | 〃 | 〃 | 〃 |  |  |  | 〃 | 〃 | 〃 | 〃 | RShift |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&mo 6` | LWin<br>`&kp LEFT_WIN` | LAlt<br>`&kp LEFT_ALT` | SPACE<br>`&lt 2 SPACE` | SPACE<br>`&lt 2 SPACE` | mo1 (L center)<br>`&mo 1` |  | mo2<br>`&mo 2` | lt1 ENTER<br>`&lt 1 ENTER` |  |  | mo6 (R)<br>`&mo 6` | mo6 (R outer)<br>`&mo 6` |
...
| 単発タップ | ESC |  |  |  |  |  |  |  |  | = | ▽ | ▽ | ▽ |
| ホールド | LShift |  |  |  |  |  |  |  |  | 〃 | 〃 | 〃 | 〃 |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&none` | LWin<br>`&trans` | LAlt<br>`&trans` | SPACE<br>`&lt 3 SPACE` | SPACE<br>`&lt 3 SPACE` | mo1 (L center)<br>`&none` |  | mo2<br>`&mo 3` | lt1 ENTER<br>`&none` |  |  | mo6 (R)<br>`&trans` | mo6 (R outer)<br>`&none` |
...
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&none` | LWin<br>`&trans` | LAlt<br>`&trans` | SPACE<br>`&none` | SPACE<br>`&none` | mo1 (L center)<br>`&mo 3` |  | mo2<br>`&none` | lt1 ENTER<br>`&lt 3 ENTER` |  |  | mo6 (R)<br>`&trans` | mo6 (R outer)<br>`&none` |
| 単発タップ |  | ▽ | ▽ |  |  | L3 |  |  | ENTER |  |  | ▽ |  |
| ホールド |  | 〃 | 〃 |  |  | 〃 |  |  | L3 |  |  | 〃 |  |
...
| 単発タップ | LShift |  |  |  |  |  |  |  |  |  |  |  | RShift |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&none` | LWin<br>`&trans` | LAlt<br>`&trans` | SPACE<br>`&none` | SPACE<br>`&none` | mo1 (L center)<br>`&none` |  | mo2<br>`&none` | lt1 ENTER<br>`&none` |  |  | mo6 (R)<br>`&trans` | mo6 (R outer)<br>`&none` |
| 単発タップ |  | ▽ | ▽ |  |  |  |  |  |  |  |  | ▽ |  |
...
| 単発タップ |  |  |  |  |  |  |  |  |  |  |  |  |  |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&none` | LWin<br>`&none` | LAlt<br>`&none` | SPACE<br>`&none` | SPACE<br>`&none` | mo1 (L center)<br>`&none` |  | mo2<br>`&none` | lt1 ENTER<br>`&none` |  |  | mo6 (R)<br>`&none` | mo6 (R outer)<br>`&none` |
| 単発タップ |  |  |  |  |  |  |  |  |  |  |  |  |  |
