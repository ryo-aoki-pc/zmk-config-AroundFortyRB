...
| ホールド | LCtrl | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | RCtrl |  |
| ■ Row 3 (Z row) | Z<br>`&mt LEFT_SHIFT Z` | X<br>`&kp X` | C<br>`&kp C` | V<br>`&kp V` | B<br>`&kp B` | (center mo7)<br>`&mo 7` | N<br>`&kp N` | M<br>`&kp M` | ,<br>`&kp COMMA` | .<br>`&kp PERIOD` | /<br>`&mt RIGHT_SHIFT SLASH` |
| 単発タップ | Z | X | C | V | B | L7 | N | M | , | . | / |
| ホールド | LShift | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | RShift |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&mo 6` | LEFT_WIN<br>`&kp LEFT_WIN` | LEFT_ALT<br>`&kp LEFT_ALT` | lt2 SPACE<br>`&lt 2 SPACE` | lt2 SPACE<br>`&lt 2 SPACE` | mo1 (L center)<br>`&mo 1` | mo2<br>`&mo 2` | mo7 (raised)<br>`&mo 7` | lt1 ENTER<br>`&lt 1 ENTER` | mo6 (R)<br>`&mo 6` | mo6 (R outer)<br>`&mo 6` |
| 単発タップ | L6 | LWin | LAlt | SPACE | SPACE | L1 | L2 | L7 | ENTER | L6 | L6 |
| ホールド | 〃 | 〃 | 〃 | L2 | L2 | 〃 | 〃 | 〃 | L1 | 〃 | 〃 |
...
| 単発タップ | TAB | &#96; | [ | ] | DEL | BS | ; | ' | &#92; | ▽ |  |
| ホールド | LCtrl | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 |  |
| ■ Row 3 (Z row) | Z<br>`&mt LEFT_SHIFT ESCAPE` | X<br>`&none` | C<br>`&none` | V<br>`&none` | B<br>`&none` | (center mo7)<br>`&none` | N<br>`&none` | M<br>`&kp EQUAL` | ,<br>`&trans` | .<br>`&trans` | /<br>`&trans` |
| 単発タップ | ESC |  |  |  |  |  |  | = | ▽ | ▽ | ▽ |
| ホールド | LShift |  |  |  |  |  |  | 〃 | 〃 | 〃 | 〃 |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&none` | LEFT_WIN<br>`&trans` | LEFT_ALT<br>`&trans` | lt2 SPACE<br>`&lt 3 SPACE` | lt2 SPACE<br>`&lt 3 SPACE` | mo1 (L center)<br>`&none` | mo2<br>`&mo 3` | mo7 (raised)<br>`&none` | lt1 ENTER<br>`&none` | mo6 (R)<br>`&trans` | mo6 (R outer)<br>`&none` |
...
| ■ Row 3 (Z row) | Z<br>`&mt LEFT_SHIFT Z` | X<br>`&kp X` | C<br>`&kp C` | V<br>`&kp V` | B<br>`&kp B` | (center mo7)<br>`&mo 7` | N<br>`&kp N` | M<br>`&kp M` | ,<br>`&kp COMMA` | .<br>`&kp PERIOD` | /<br>`&mt RIGHT_SHIFT SLASH` |
| 単発タップ | &mt LEFT_SHIFT Z | &kp X | &kp C | &kp V | &kp B | &mo 7 | &kp N | &kp M | &kp COMMA | &kp PERIOD | &mt RIGHT_SHIFT SLASH |
| ホールド | &mt LEFT_SHIFT Z | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | 〃 | &mt RIGHT_SHIFT SLASH |
| ■ Row 4 (thumb) | mo6 (L outer)<br>`&mo 6` | LEFT_WIN<br>`&kp LEFT_WIN` | LEFT_ALT<br>`&kp LEFT_ALT` | lt2 SPACE<br>`&lt 2 SPACE` | lt2 SPACE<br>`&lt 2 SPACE` | mo1 (L center)<br>`&mo 1` | mo2<br>`&mo 2` | mo7 (raised)<br>`&mo 7` | lt1 ENTER<br>`&lt 1 ENTER` | mo6 (R)<br>`&mo 6` | mo6 (R outer)<br>`&mo 6` |
| 単発タップ | &mo 6 | &kp LEFT_WIN | &kp LEFT_ALT | &lt 2 SPACE | &lt 2 SPACE | &mo 1 | &mo 2 | &mo 7 | &lt 1 ENTER | &mo 6 | &mo 6 |
